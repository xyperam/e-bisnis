...
// keluarkan hasil
      ...
      $_SESSION["login"] = true; //session login true
    ...
    <div class="Masuk2">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8">
            ...
            <p>Oh hi... do you already have an account ? if yes you can log in here, if you don't have an account you can <a href="Signup.php">sign up</a></p>

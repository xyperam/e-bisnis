    ...
    <a class="navbar-brand" href="#">WHITESHOES</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link animated bounceInRight" style = "animation-delay: 1.5s" href="Login.php">Sign Up / Login</a>
            </li>
...
<!-- Awal Jumbotron -->
    <section class="jumbotron" id="jmbtrn1">
      <div class="container-fluid">
...
<!-- KREDIBILITAS DI MULAI -->       
<section class="kredibilitas" id="kredibilitas"> 
      <div class="container">
